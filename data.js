...
var FAST_FOOD_STEPS = [
  { key: "pizza", section: "Fast Food", kind: "question", layout: "grid2", icon: "pizza",
  ...
  { key: "burger", section: "Fast Food", kind: "question", layout: "grid2", icon: "burger",
    title: "Go-to burger?",
...
var QUICK_COMMERCE_STEPS = [
  { key: "chips", section: "Quick Commerce", kind: "question", layout: "grid2", icon: "chips",
    title: "Favourite chips?",
    options: [{ id: "lays", label: "Lay's" }, { id: "kurkure", label: "Kurkure" }, { id: "bingo", label: "Bingo" }, optOut("Don't eat chips")] },
  { key: "cold_drink", section: "Quick Commerce", kind: "question", layout: "grid2", icon: "soda",
  ...
  { key: "biscuits", section: "Quick Commerce", kind: "question", layout: "grid2", icon: "biscuit",
  ...
  { key: "choco_wafer", section: "Quick Commerce", kind: "question", layout: "grid2", icon: "chocolate",
...
var INSTANT_FOOD_STEPS = [
  { key: "noodles", section: "Instant Food", kind: "question", layout: "grid2", icon: "noodles",
  ...
  { key: "oats", section: "Instant Food", kind: "question", layout: "grid2", icon: "oats",
  ...
  { key: "peanut_butter", section: "Instant Food", kind: "question", layout: "grid2", icon: "peanutbutter", endOfSection: true,
...
var LAUNDRY_STEPS = [
  { key: "detergent", section: "Laundry & Toothpaste", kind: "question", layout: "column", icon: "detergent",
  ...
  { key: "toothpaste", section: "Laundry & Toothpaste", kind: "question", layout: "column", icon: "toothpaste", endOfSection: true,
...
var SUPPLEMENTS_STEPS = [
  { key: "sup_protein", section: "Supplements", kind: "question", layout: "grid2", icon: "protein",
  ...
  { key: "sup_creatine", section: "Supplements", kind: "question", layout: "grid2", icon: "creatine", endOfSection: true,
...
var SKINCARE_STEPS = [
  { key: "sunscreen", section: "Skincare", kind: "question", layout: "grid2", icon: "sunscreen",
  ...
  { key: "facewash", section: "Skincare", kind: "question", layout: "column", icon: "facewash",
  ...
  { key: "moisturizer", section: "Skincare", kind: "question", layout: "grid2", icon: "moisturizer", endOfSection: true,
...
var COOKING_STEPS = [
  { key: "oil_ghee", section: "Cooking", kind: "question", layout: "grid2", icon: "oil",
  ...
  { key: "masala", section: "Cooking", kind: "question", layout: "grid2", icon: "masala",
    title: "Masala brand?",
    options: [{ id: "mdh", label: "MDH" }, { id: "everest", label: "Everest" }, { id: "catch", label: "Catch" }, otherOpt("Other", "Which one?")] },
  { key: "atta_rice", section: "Cooking", kind: "question", layout: "grid2", icon: "atta", endOfSection: true,
